...
import { Bell, Briefcase, Users, Clock3, MailCheck, Circle } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-400">Updates about your jobs and platform announcements.</p>
        </div>
      ...
      {isLoading ? (
        ...
        <EmptyState
          ...
          description={unreadOnly ? 'No unread notifications right now.' : "Updates about your postings will show up here."}
        />
      ) : (
        <div className="space-y-3">
